<?php 
require 'db.php';
$ordens = $pdo->query('SELECT os.*, c.nome AS cliente, t.nome AS tecnico FROM ordens_de_servico os JOIN clientes c ON os.cliente_id = c.id JOIN tecnicos t ON os.tecnico_id = t.id')->fetchAll(PDO::FETCH_ASSOC);
?>
