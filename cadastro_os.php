...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	try {
	$stmt = $pdo->prepare('INSERT INTO ordens_de_servico (cliente_id, tecnico_id, data, descricao, status) VALUES (:cliente_id, :tecnico_id, :data, :descricao, :status)');
	$stmt->execute([':cliente_id' => $cliente_id, ':tecnico_id' => $tecnico_id, ':data' => $data, ':descricao' => $descricao, ':status' => $status]);
